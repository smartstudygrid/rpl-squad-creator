...
# --- NAVIGATION: SQUAD SCREEN ---
    ...
    with c_col:
        ...
        if cap_pic:
            st.markdown(f'<div class="img-box" style="width:200px; height:200px; border:4px solid #facc15;"><img src="data:image/jpeg;base64,{cap_pic}"></div>', unsafe_allow_html=True)
        else:
